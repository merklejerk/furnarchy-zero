...
export interface DSBLine {
	type: number; // 0: cmd type
	subtype: number; // 1: subtype/id
	params: number[]; // 2-9: args
}
 ...
 */
function decryptDSB(buffer: Uint8Array, offset: number, useTableB: boolean): Uint8Array {
 ...
 */
export function parseDSB(buffer: Uint8Array): DSBFile {
