import{i as gt,a as O,f as $,e as q,s as V}from"../chunks/TaKWw6Tr.js";import{i as Qe}from"../chunks/j2M9h5Jk.js";import{o as Ye}from"../chunks/r3_wVOpG.js";import{b1 as vt,aC as mt,B as Ve,a7 as Me,a8 as Je,F as Ke,z as we,a as e,a3 as P,G as w,s as z,b2 as pt,H as y,I as b,C as et,aa as Te,u as W,E as J,n as bt,a9 as wt}from"../chunks/WP6s4_OC.js";import{i as Q,s as yt,a as _t}from"../chunks/DEPZNxei.js";import{f as se,h as kt}from"../chunks/BZxPs6Fa.js";import{s as zt}from"../chunks/BTtjwMQY.js";import{b as xt}from"../chunks/YWP4DBZ4.js";import{p as De,n as Ct,g as Mt,h as ue,l as St,o as Lt,r as ye,e as Pt,s as qe,d as _e,f as ke,k as Et,i as Wt,b as Ne,q as Ft,m as Ut,v as It,c as ze,a as Ot}from"../chunks/Bortks6V.js";import{p as xe}from"../chunks/CByjIOJv.js";import"../chunks/8UtF8RsF.js";function Xe(o,l){vt(window,["resize"],()=>mt(()=>l(window[o])))}function At(o,l){let s=l;s.endsWith("/")||(s+="/");const v=o.startsWith("/")?o.substring(1):o;return new URL(v,s).toString()}function Rt(o,l){const s=new URL(o),v=new URL(l),u=s.pathname.startsWith("/")?s.pathname.substring(1):s.pathname;let H=v.pathname;return H.endsWith("/")||(H+="/"),v.pathname=H+u,v.search=s.search,v.hash=s.hash,v.toString()}function $t(o){return!o.match(/^https?:\/\//)&&!o.startsWith("data:")&&!o.startsWith("blob:")}function Ht(o){return o.startsWith("http://local-server.furcadia.com:8080/")||o.startsWith("https://terra.furcadia.com/")}function Bt(o,l,s){const v=o,u=v.XMLHttpRequest;v.FurcXMLHttpRequest=class extends u{static UNSENT=0;static OPENED=1;static HEADERS_RECEIVED=2;static LOADING=3;static DONE=4;open(C,_,...M){let h=_.toString();return $t(h)?(h=At(h,l),console.log(`[FurcXMLHttpRequest] Remapped relative URL to: ${h}`)):Ht(h)&&(h=Rt(h,s),console.log(`[FurcXMLHttpRequest] Remapped backend URL to: ${h}`)),super.open(C,h,...M)}}}class Ge{buffer="";append(l){this.buffer+=l;const s=[];let v;for(;(v=this.buffer.indexOf(`
`))!==-1;){const u=this.buffer.substring(0,v);s.push(u),this.buffer=this.buffer.substring(v+1)}return s}get isEmpty(){return this.buffer.length===0}clear(){this.buffer=""}}function Tt(o){const l=o,s=l.MessageEvent,v=l.Blob,u=l.Uint8Array,H=l.ArrayBuffer,C={encode:a=>{const t=a.length,n=new u(t);for(let g=0;g<t;g++)n[g]=a.charCodeAt(g)&255;return n}},_={decode:a=>{if(typeof a=="string")return a;let t;a instanceof u?t=a:a instanceof H||a instanceof ArrayBuffer?t=new u(a):t=new u(a.buffer,a.byteOffset,a.byteLength);let n="";const g=t.length,m=32768;for(let k=0;k<g;k+=m){const S=t.subarray(k,Math.min(k+m,g));n+=String.fromCharCode.apply(null,S)}return n}};let M=null,h;l.waitForFurc=new Promise(a=>{h=a});function L(a,t,n,g){t.endsWith(`
`)||(t+=`
...
`)||(t+=`
`);const m=C.encode(t);a.sendTagged?a.sendTagged(m,n,g):a.send(m)}}const x=l.WebSocket;l.FurcWebSocket=class extends x{static CONNECTING=0;static OPEN=1;static CLOSING=2;static CLOSED=3;_outgoingQueue=Promise.resolve();_incomingQueue=Promise.resolve();_incomingBuffer=new Ge;_outgoingBuffer=new Ge;constructor(t,n){if(super(t,n),t.toString().includes("furcadia")||t.toString().includes("6502")){console.log("%c😈 Game Socket Captured","color: #ff00ff;"),M=this;const g=se;g&&(g.send=(m,k,S)=>F(this,m,k,S),g.inject=(m,k,S)=>L(this,m,k,S),console.log("[Furnarchy] Connected to Game Socket")),this.addEventListener("open",()=>{h(this);const m=se;m&&m.notifyConnected()}),this.addEventListener("close",()=>{const m=se;m&&m.notifyDisconnected()})}}send(t){this.sendTagged(t,void 0,void 0)}sendTagged(t,n,g){if(M!==this){super.send(t);return}this._outgoingQueue=this._outgoingQueue.then(async()=>{let m=typeof t=="string"?t:_.decode(t);const k=this._outgoingBuffer.append(m);if(k.length===0)return;const S=[];for(let N of k){const B=se;if(B){const I=await B.processOutgoing(N,n,g);if(I==null){console.log("%c🚫 Outgoing Dropped (Furnarchy)","color: gray; font-size: 9px");continue}N=I}S.push(N)}if(S.length===0)return;const j=S.join(`
`)+`
`,Z=C.encode(j);super.send(Z)}).catch(m=>{console.error("Error in outgoing message queue:",m)})}_hookMessageEvent(t,n){const g=t.tag,m=t.sourceId;this._incomingQueue=this._incomingQueue.then(async()=>{let k=typeof t.data=="string"?t.data:_.decode(t.data);const S=this._incomingBuffer.append(k);if(S.length===0)return;const j=[];for(let I of S){const Y=se;if(Y){const ee=await Y.processIncoming(I,m,g);if(ee==null)continue;I=ee}j.push(I)}if(j.length===0)return;const Z=j.join(`
`)+`
`;let N=Z;this.binaryType==="arraybuffer"?N=C.encode(Z).buffer:this.binaryType==="blob"&&(N=new v([C.encode(Z)]));const B=new s("message",{data:N,origin:t.origin,source:t.source});n(B)}).catch(k=>{console.error("Error in incoming message queue:",k)})}set onmessage(t){M===this&&t?super.onmessage=n=>{this._hookMessageEvent(n,g=>{t.call(this,g)})}:super.onmessage=t}get onmessage(){return super.onmessage}addEventListener(t,n,g){if(t==="message"&&M===this&&typeof n=="function"){const m=k=>{this._hookMessageEvent(k,S=>{n.call(this,S)})};super.addEventListener(t,m,g);return}super.addEventListener(t,n,g)}}}async function Dt(o,l){const s=o,v=await fetch(l);if(!v.ok)throw new Error(`Failed to fetch client script: ${v.statusText}`);let u=await v.text();u=u.replaceAll("XMLHttpRequest","FurcXMLHttpRequest"),u=u.replaceAll("WebSocket","FurcWebSocket");const H=u.length;u=(()=>{let _=u.indexOf("Missing login data");if(_===-1)return u;const M=u.substring(0,_),h="__instantiate",L=`
            let ${h} = (cls, ...args) => {
...
`;var si=$('<div class="loading svelte-hy9bcf"><p>Loading Furcadia Web Client...</p></div>'),ri=$('<div class="error svelte-hy9bcf"><p> </p> <button class="svelte-hy9bcf">Try Again</button></div>'),oi=$('<!> <!> <div class="iframe-container svelte-hy9bcf"><iframe title="Furcadia Client" class="game-iframe svelte-hy9bcf"></iframe></div> <!>',1);function yi(o,l){Ve(l,!1);const s=P(),v=ze.PUBLIC_FURCADIA_CLIENT_JS_URL,u=ze.PUBLIC_AUTH_PROXY_URL,H=ze.PUBLIC_PLAY_FURCADIA_URL;let C=P(!1),_=P(""),M=!1,h=P(),L=P(640),F=P(480),x=P(!1),a=P(1.5),t=P(!1),n=P(1024),g=P(768);Ye(()=>{const A=Ot()||u;if(console.log(`[Furnarchy] Using backend URL: ${A}`),window.addEventListener("message",m),e(h)&&e(h).contentWindow&&e(h).contentDocument){const i=e(h).contentDocument,f=e(h).contentWindow;i.open(),i.write(ni),i.close(),Bt(f,H,A),Tt(f),se.attachInputInterception(i),k(f)}return()=>{window.removeEventListener("message",m)}});function m(p){p.data&&p.data.type==="resize"&&(z(L,Math.ceil(p.data.width)),z(F,Math.ceil(p.data.height)),z(x,!!p.data.isMobile))}async function k(p){if(!M){z(C,!0),z(_,"");try{await Dt(p,v),M=!0}catch(A){console.error(A),z(_,A.message||"An unknown error occurred")}finally{z(C,!1)}}}Me(()=>(e(x),e(t),e(n),e(L),e(g),e(F),e(a)),()=>{z(s,e(x)?1:e(t)?Math.min(e(n)/e(L),e(g)/e(F)):e(a))}),Je(),Qe();var S=oi();kt("hy9bcf",p=>{bt(()=>{wt.title="Furnarchy Zero"})});var j=et(S);ii(j,{get isMobileMode(){return e(x)},get zoomLevel(){return e(a)},set zoomLevel(p){z(a,p)},get fitWidth(){return e(t)},set fitWidth(p){z(t,p)},$$legacy:!0});var Z=b(j,2);{var N=p=>{var A=si();O(p,A)};Q(Z,p=>{e(C)&&p(N)})}var B=b(Z,2),I=w(B);xt(I,p=>z(h,p),()=>e(h)),y(B);var Y=b(B,2);{var ee=p=>{var A=ri(),i=w(A),f=w(i);y(i);var d=b(i,2);y(A),J(()=>V(f,`Error: ${e(_)??""}`)),q("click",d,()=>window.location.reload()),O(p,A)};Q(Y,p=>{e(_)&&p(ee)})}J(()=>zt(I,`width: ${e(x)?"100%":e(L)+"px"}; height: ${e(x)?"100%":e(F)+"px"}; --zoom: ${e(s)??""};`)),Xe("innerWidth",p=>z(n,p)),Xe("innerHeight",p=>z(g,p)),O(o,S),Ke()}export{yi as component};
