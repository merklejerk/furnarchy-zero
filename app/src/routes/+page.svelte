...
<div class="landing-page retro-theme">
    ...
    <main>
        ...
        <div class="info-section">
            <h2>About</h2>
            <p>
                Furnarchy Zero is a wrapper around the official Furcadia web client that enables 
                client-side scripting and plugins. Brought to you by the author of Furnarchy 1, 3, and 2 (yes, counting is hard).
            </p>
            <p>
                ...
                game session. Only install plugins from trusted sources.
            </p>
        </div>
