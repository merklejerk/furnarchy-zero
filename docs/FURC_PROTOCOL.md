...
This document focuses on the network protocol. For detailed technical specifications of Furcadia's binary file formats, refer to the individual specification files:

*   **[FOX5 Specification](fox5-spec.md)**: Asset container for v31+ sprites and metadata.
*   **[MAP Specification](map-spec.md)**: Binary format for dream layouts (grid data).
*   **[FR01 Specification](fr01-spec.md)**: Linear resource archive/bundle format.

---

## 2. Data Types & Encodings
